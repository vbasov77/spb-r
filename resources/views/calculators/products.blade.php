...
@section('content')
    <section>
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center text-center">
                <div class="col-lg-4">
                    <h3 style="margin-top: 60px; margin-bottom: 40px">Калькулятор продуктов</h3>
                    <form id="form">
                    ...
                    <br>
                    <br>
                    <a href="{{asset(route('productSumPacCalculator'))}}" class="btn btn-outline-primary btn-sm" type="submit" >Калькулятор сумма упаковки</a>
                    <br>
                    <br>
                </div>
            </div>
    ...
    <script>
        ...
        function calculate() {
            ...
            const totalCost = price / weight * 1000;
