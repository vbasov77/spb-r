        ...
        <div class="container">
            <div class="site-navbar bg-light">
                ...
                <div class="row align-items-center">
                    <div class="col-2">
                        <h2 class="mb-0 site-logo"><a style="text-decoration: none;" href="{{route('recipes')}}"
                                                      class="font-weight-bold">RECIPES</a>
                        </h2>
                    </div>
...
<footer class="footer bg-black small text-center text-white-50">
    <div class="container px-4 px-lg-5">Recipes &copy; {{date('Y')}}</div>
