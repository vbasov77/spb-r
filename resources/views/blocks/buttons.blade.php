...
<button onclick="window.location.href = 'https://t.me/var_damp';" style="bottom: 50px; background: #0d6efd;"
        class="pulse-button">
    <span style="background: url('{{asset('icons/telegram.svg')}}') center center no-repeat;" class="pulse-button__icon"></span>
...
<button onclick="window.location.href = 'https://wa.clck.bar/79110120912';" style="bottom: 130px; background: #198754;"
        class="pulse-button">
    <span style="background: url('{{asset('icons/watsappW.svg')}}') center center no-repeat;" class="pulse-button__icon"></span>
