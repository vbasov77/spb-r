                    ...
                    <form action="/rules_edit" method="post">
                        ...
                        <div >
                            ...
                            <input name="rules[]" type="text" value="<?= $rules [1] ?? '' ?>"
                                   ...
                                   placeholder="Минимум дней" onkeypress="return (event.charCode >= 48 && event.charCode <= 57 && /^\d{0,3}$/.test(this.value));" autocomplete="off" required>
                        </div>
                        <br>
                        <div >
                            ...
                            <input name="rules[]" type="text" value="<?= $rules [2] ?? '' ?>"
                                   class="form-control" style="text-align: center"
                                   placeholder="Максимум дней" onkeypress="return (event.charCode >= 48 && event.charCode <= 57 && /^\d{0,3}$/.test(this.value));" autocomplete="off" required>
                        </div>
